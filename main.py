...
def znajdz_szczyty(file):
    ...
    # plt.show()
    return (peaks, accelerometer_filtered_data)


if __name__ == '__main__':
    # Ręka - Laura
    filename_1 = "kroki/8/acc_data_reka_1.csv"
    filename_2 = "kroki/8/acc_data_reka_2.csv"
    filename_3 = "kroki/8/acc_data_reka_3.csv"
    filename_4 = "kroki/8/acc_data_reka_4.csv"
    filename_5 = "kroki/8/acc_data_reka_5.csv"
    ...
    # Ręka - Natalia
    # filename_1 = "kroki/8/acc_data_Natalia_1.csv"
    # filename_2 = "kroki/8/acc_data_Natalia_2.csv"
    # filename_3 = "kroki/8/acc_data_Natalia_3.csv"
    # filename_4 = "kroki/8/acc_data_Natalia_4.csv"
    # filename_5 = "kroki/8/acc_data_Natalia_5.csv"

    list_filenames = [filename_1, filename_2, filename_3, filename_4, filename_5]

    for file in list_filenames:
        (peaks, accelerometer_filtered_data) = znajdz_szczyty(file)
